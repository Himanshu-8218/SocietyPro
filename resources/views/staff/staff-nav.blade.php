...
<head>
    ...
    @livewireStyles
  <title>SocietyPro | Maintenance Staff</title>
...
<body >
    <div class="sidebar sidebar-narrow-unfoldable border-end sidebar-dark">
        ...
        <ul class="sidebar-nav">
          ...
          <li class="nav-item">
            <a class="nav-link" href="{{ route('staff/complaint-board') }}">
              <i class="nav-icon bi bi-person-lines-fill"></i> Complaint
            </a>
          </li>
          <li class="nav-item">
            <a class="nav-link" href="{{ route('staff/activity') }}">
      ...
      <div class="dropdown-center">
        ...
        <ul class="dropdown-menu">
          <li><a class="dropdown-item" href="{{ route('staff/profile') }}"><i class="bi bi-person-fill-up ms-4">  </i>Profile</a></li>
